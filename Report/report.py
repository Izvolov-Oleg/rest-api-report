...
class Racer:
    ...
    def __init__(self, abbr_name, name, team, result):
        """
        Constructor.
        Arguments required:
        abbr_name:str, name:str, team:str, result:timedelta
        """
...
def build_report(folder_path: str) -> list:
    ...
    report_out = [Racer(racer, abbs[racer][0], abbs[racer][1], results[racer]) for racer in results.keys()]
    report_out.sort()
    return report_out
